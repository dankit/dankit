...
**[adversarial-agents-research-outline](https://github.com/dankit/adversarial-agents-research-outline)** · *In progress* — **computer use agents** to complete web tasks and captchas while mimicking plausible human behavior: Playwright harness, SFT & RL, gym environment, and my own data designer to turn manually collected seed data into high-quality synthetic data. Building directly into this project: **[discord_sft_preview](https://github.com/dankit/discord_sft_preview)** Multi-turn **supervised fine-tuning** from raw, personal conversational data with focus on high-quality dialogue SFT. Uses Unsloth's training library for fused MoE kernels & LoRA on qwen3.5-35b-a3b, training based on model interpretability research papers, LoRA hotswap to vLLM for efficient inference and parallelized multi-modal evals, and more.
